...
Saídas: ../BPMN_Checkout.svg
        ../BPMN_PublicacaoAnuncio.svg
...
def diagrama_checkout():
    ...
    b.append(annotation(560, 770, 220, 50,
                        ["Validação só na submissão (RN-B06):",
                         "o erro só aparece após o envio"], (792, 835)))
...
if __name__ == "__main__":
    ...
    for nome, fn in (("BPMN_Checkout.svg", diagrama_checkout),
                     ("BPMN_PublicacaoAnuncio.svg", diagrama_anuncio)):
