...
A Wiki ou GitPages do Projeto deve conter um tópico dedicado ao Módulo Desenho de Software (Base), com uma subpasta Relatórios (1.1), contendo [1.1.1](/Base/Relatórios/1.1.1.SubEquipe_01.md), [1.1.2](Base/Relatórios/1.1.2.SubEquipe_02.md) e [1.1.3](/Base/Relatórios/1.1.3.SubEquipe_03.md). Adicionalmente, deve constar um subtópico sobre as participações, conforme [1.2](/Base/1.2.ParticipacoesBase.md). Por fim, pode constar um subtópico, chamado [1.3](/Base/1.3.IniciativasExtras.md), no qual podem ser colocadas quaisquer iniciativas extras, caso ocorram (opcional). **Cada subequipe deve revelar principalmente: Rastreabilidade & Elos com Outros Artefatos, Senso Crítico, Referências, Versionamentos & Participações e Metodologia.**
