...
**O estado viaja na URL, e isso é uma decisão de projeto, não um acaso.** Aparece nos três recortes: o estado da consulta em A (RN-A06), o contexto de retorno entre subdomínios em B (RN-B03) e o identificador do rascunho em C (RN-C02). O ganho é o mesmo nos três — fluxo compartilhável e retomável. O custo também: qualquer dado colocado ali fica exposto no histórico, em logs e no cabeçalho de referência, o que sustenta RNF-B05 e RNF-C01 e é o ponto de partida do [SIG de Segurança](/Base/Relatórios/SubEquipe01/NFR.md).
...
| -- | -- | -- |
| RNF-B05, RNF-C01 — dados na URL | [SIG de Segurança](/Base/Relatórios/SubEquipe01/NFR.md) | Justificam o softgoal `Confidencialidade` e o *claim* que o sustenta |
| RN-B05, RN-B06 — validação por script, na submissão | [SIG de Segurança](/Base/Relatórios/SubEquipe01/NFR.md) | Operacionalização `Validar no servidor` e sua correlação negativa |
...
| -- | -- | -- | -- | -- |
| 1.0 | 26/08/2026 | Criação da página com a engenharia reversa do fluxo de busca e escolha de produto | Pedro Luciano de Azevedo | -- |
| 1.1 | 27/08/2026 | Adição da engenharia reversa do fluxo de carrinho, endereço e entrada de checkout | Patrick Anderson Carvalho dos Santos | -- |
| 1.2 | 27/08/2026 | Revisão do texto do Pedro Luciano, condensação da escrita em um documento único de grupo e ampliação do espectro de análise com o recorte de publicação de anúncio pelo vendedor; unificação da numeração de regras, requisitos e transições | Patrick Anderson Carvalho dos Santos | Pedro Luciano de Azevedo |
